...
// public methods
#if defined(USBCON)
MeetAndroid::MeetAndroid(): amarinoSerial(Serial1)
#else
MeetAndroid::MeetAndroid(): amarinoSerial(Serial)
#endif
{
...
#if defined(USBCON)
MeetAndroid::MeetAndroid(H_voidFuncPtr err): amarinoSerial(Serial1)
#else
MeetAndroid::MeetAndroid(H_voidFuncPtr err): amarinoSerial(Serial)
#endif
{    
...
MeetAndroid::MeetAndroid(Stream &stream): amarinoSerial(stream)
{
    customErrorFunc = true;
	errorFunc = 0;
	init();
